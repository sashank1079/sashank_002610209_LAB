...
public class CreateJPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        add(packageId, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 80, 100, -1));
        add(packageWt, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 130, 100, 20));
        add(custId, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 190, 100, 20));
        add(productId1, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 70, 110, 20));
        add(productName1, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 130, 110, 20));
        add(productPrice1, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 190, 100, -1));
        ...
        add(custName1, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 250, 80, 20));

        jLabel1.setText("Customer ID");
        add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 250, -1, 20));
        ...
        add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 70, -1, 20));

        jLabel5.setText("Product Name");
        add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 130, -1, 20));

        jLabel6.setText("Product Price");
        add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 190, -1, 20));

        jLabel7.setText("Customer name");
        add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 190, -1, 20));
        ...
        add(btnSave, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 300, -1, -1));
        ...
        add(saveProductbtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 250, 120, -1));
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        ...
        // store the data
        this.delPackage.setPackageId(Integer.parseInt(id));
        this.delPackage.setPackageWeight(Double.parseDouble(weight));
        
     
        Customer customer = this.delPackage.getCustomer();
        customer.setCustId(Integer.parseInt(customerId));
        customer.setfName(customername);
    ...
    private void saveProductbtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveProductbtnActionPerformed
        ...
        Product product = this.delPackage.createProduct(Integer.parseInt(productId), productName, Double.parseDouble(productPrice));
