...
public class ViewJPanel extends javax.swing.JPanel {
    ...
    public void displayObservation(){
        ...
        if(!history.getVitalSignHHistory().isEmpty()){
            //display
    ...
    private void initComponents() {
        ...
        add(updObsBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(126, 228, -1, -1));
        ...
        add(viewObsBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 470, -1, -1));
    ...
    private void updObsBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updObsBtnActionPerformed
       ...
       if( !fieldObsId.getText().isEmpty()){ 
        //update the observation object
            ...
            Observation o = this.application.getHistory().findObservation(Integer.parseInt(fieldObsId.getText()));
            o.setBloodPressure(Double.parseDouble(fieldBloodPressure.getText()));
            o.setTemperature(Double.parseDouble(fieldTemp.getText()));


            this.selectedObs.setBloodPressure(Double.parseDouble(fieldBloodPressure.getText()));
            this.selectedObs.setTemperature(Double.parseDouble(fieldTemp.getText()));
       } else {
